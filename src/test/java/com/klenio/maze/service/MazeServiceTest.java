...
class MazeServiceTest {
    ...
    void getSmallestNumberOfTurns() {
        ...
        */
        ...
        maze2.addPosition(new Position(2, 0, 0));
        maze2.addPosition(new Position(3, 0, 0));
        maze2.addPosition(new Position(4, 0, 0));
        maze2.addPosition(new Position(5, 0, 0));
        maze2.addPosition(new Position(6, 0, 0));
        maze2.addPosition(new Position(7, 0, 0));
        maze2.addPosition(new Position(8, 0, 0));
        maze2.addPosition(new Position(0, 1, 1));
        maze2.addPosition(new Position(1, 1, 1));
        maze2.addPosition(new Position(2, 1, 1));
        maze2.addPosition(new Position(3, 1, 1));
        maze2.addPosition(new Position(4, 1, 1));
        maze2.addPosition(new Position(5, 1, 1));
        maze2.addPosition(new Position(6, 1, 1));
        maze2.addPosition(new Position(7, 1, 0));
        maze2.addPosition(new Position(8, 1, 0));
        maze2.addPosition(new Position(0, 2, 0));
        maze2.addPosition(new Position(1, 2, 0));
        maze2.addPosition(new Position(2, 2, 1));
        maze2.addPosition(new Position(3, 2, 0));
        maze2.addPosition(new Position(4, 2, 0));
        maze2.addPosition(new Position(5, 2, 0));
        maze2.addPosition(new Position(6, 2, 1));
        maze2.addPosition(new Position(7, 2, 0));
        maze2.addPosition(new Position(8, 2, 0));
        maze2.addPosition(new Position(0, 3, 0));
        maze2.addPosition(new Position(1, 3, 0));
        maze2.addPosition(new Position(2, 3, 1));
        maze2.addPosition(new Position(3, 3, 0));
        maze2.addPosition(new Position(4, 3, 0));
        maze2.addPosition(new Position(5, 3, 0));
        maze2.addPosition(new Position(6, 3, 1));
        maze2.addPosition(new Position(7, 3, 0));
        maze2.addPosition(new Position(8, 3, 0));
        maze2.addPosition(new Position(0, 4, 0));
        maze2.addPosition(new Position(1, 4, 0));
        maze2.addPosition(new Position(2, 4, 1));
        maze2.addPosition(new Position(3, 4, 1));
        maze2.addPosition(new Position(4, 4, 1));
        maze2.addPosition(new Position(5, 4, 0));
        maze2.addPosition(new Position(6, 4, 1));
        maze2.addPosition(new Position(7, 4, 0));
        maze2.addPosition(new Position(8, 4, 0));
        maze2.addPosition(new Position(0, 5, 0));
        maze2.addPosition(new Position(1, 5, 0));
        maze2.addPosition(new Position(2, 5, 0));
        maze2.addPosition(new Position(3, 5, 0));
        maze2.addPosition(new Position(4, 5, 1));
        maze2.addPosition(new Position(5, 5, 0));
        maze2.addPosition(new Position(6, 5, 1));
        maze2.addPosition(new Position(7, 5, 0));
        maze2.addPosition(new Position(8, 5, 0));
        maze2.addPosition(new Position(0, 6, 0));
        maze2.addPosition(new Position(1, 6, 0));
        maze2.addPosition(new Position(2, 6, 0));
        maze2.addPosition(new Position(3, 6, 0));
        maze2.addPosition(new Position(4, 6, 1));
        maze2.addPosition(new Position(5, 6, 1));
        maze2.addPosition(new Position(6, 6, 1));
        maze2.addPosition(new Position(7, 6, 1));
        maze2.addPosition(new Position(8, 6, 1));
        maze2.addPosition(new Position(0, 7, 0));
        maze2.addPosition(new Position(1, 7, 0));
        maze2.addPosition(new Position(2, 7, 0));
        maze2.addPosition(new Position(3, 7, 0));
        maze2.addPosition(new Position(4, 7, 0));
        maze2.addPosition(new Position(5, 7, 0));
        maze2.addPosition(new Position(6, 7, 0));
        maze2.addPosition(new Position(7, 7, 0));
        maze2.addPosition(new Position(8, 7, 0));
        MazeService mazeService2 = new MazeService(maze2);
        /*
        000000000
        111111100
        ...
        */
        //when
        int result1 = mazeService1.getSmallestNumberOfTurns();
        int result2 = mazeService2.getSmallestNumberOfTurns();
        //then
